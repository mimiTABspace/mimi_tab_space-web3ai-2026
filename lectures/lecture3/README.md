...
| 一言紹介 | 育成ゲーム×体調・服薬・通院予定の記録管理ツール（MVP後のアプリ） |
| デプロイURL(SCNote) | https://self-care-note.vercel.app/ |
| 一言紹介 | ゲーム要素なし・体調・服薬・通院管理に特化したシンプル版（家族共有・PWA対応） |
